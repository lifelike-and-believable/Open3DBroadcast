...
- **Follow**
   ...
   - **Version Control Best Practices:** Use meaningful commit messages, branch naming conventions, and pull request templates to maintain a clean and organized repository.
   - **Refactoring:** Regularly refactor code to improve structure, readability, and maintainability without changing external behavior.
- **Avoid**
   ...
   - **Proliferation of Global State:** Minimize the use of global variables or singletons to reduce coupling and improve testability. 
   - **Blocking on the Game Thread:** Avoid any operations that block the game thread, ensuring smooth gameplay and responsiveness. 
